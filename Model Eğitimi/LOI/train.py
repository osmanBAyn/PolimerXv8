...
def get_features(smiles_str, n_bits=1024):
    try:
...
def load_data(filename):
    ...
    df = df.rename(columns={'prompt': 'smiles', 'SMILES': 'smiles', target_col: 'value'})
...
dataset_path = './LOI/loi_dataset.csv' 
...
if X is not None and y is not None:
    ...
    plt.xlabel('Gerçek LOI Değerleri', fontsize=20)
    plt.ylabel('Tahmin Edilen LOI Değerleri', fontsize=20)
    plt.legend()
